        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-2 lg:items-start">
          <div className="space-y-6">
            {steps.map((step, index) => (
              <div
                key={step.title}
                className="rounded-2xl border border-fuchsia-400/30 bg-white/3 p-6 backdrop-blur-sm shadow-[0_0_0_1px_rgba(232,121,249,0.15),0_0_24px_rgba(255,255,255,0.08),0_0_60px_rgba(217,70,239,0.2)]">
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-fuchsia-500/20 text-lg font-bold text-fuchsia-400">
                    {index + 1}
                  </div>
                  <div className="flex-1">
                    ...
                    {step.hasButton && (
                      <div className="mt-4">
                        <Button href="#lead" variant="heroCta" size="lg">
                          Заказать со скидкой
                        </Button>
                      </div>
                    )}
